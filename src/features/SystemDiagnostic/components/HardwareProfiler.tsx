      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-sm font-medium text-orange-600">68°C</span>
          </div>
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-sm font-medium text-orange-600">78°C</span>
          </div>
          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
            <div className="bg-gradient-to-r from-red-600 to-red-500 h-2.5 rounded-full transition-all duration-500" style={{ width: '85%' }}></div>
          </div>
          <div className="mt-2 flex justify-between text-sm text-gray-500 dark:text-gray-400">
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-sm font-medium text-green-600">45.2 GB used</span>
          </div>
          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
            <div className="bg-gradient-to-r from-red-600 to-red-500 h-2.5 rounded-full transition-all duration-500" style={{ width: '78%' }}></div>
          </div>
          <div className="mt-2 flex justify-between text-sm text-gray-500 dark:text-gray-400">
