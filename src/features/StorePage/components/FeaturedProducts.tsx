    ...
    <section id="featured" className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Product 1 */}
          <div className="product-card bg-card rounded-2xl overflow-hidden shadow-lg relative">
            <div className="card-header relative">
              <div className="tier-badge absolute top-3 left-3 z-10">
                <span className="px-3 py-1 bg-gradient-to-r from-jstar-blue to-faith-purple text-white rounded-full text-xs font-bold">
                  BEST SELLER
                </span>
              </div>
              <div className="h-48 bg-gradient-to-br from-jstar-blue to-faith-purple flex items-center justify-center rounded-t-2xl">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-foreground">YouTube Virality Masterclass</h3>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <span className="text-sm text-muted-foreground line-through ml-2">₦60,000</span>
                </div>
          ...
          <div className="product-card bg-card rounded-2xl overflow-hidden shadow-lg relative">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-foreground">Wedding Film Editing Templates</h3>
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-muted-foreground ml-2">(86 reviews)</span>
              </div>
              <div className="flex justify-between items-center">
                <div>
          ...
          <div className="product-card bg-card rounded-2xl overflow-hidden shadow-lg relative">
            <div className="card-header relative">
              ...
              <div className="h-48 bg-gradient-to-br from-growth-green to-jstar-blue flex items-center justify-center rounded-t-2xl">
                <div className="text-center text-white">
                  <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-3">
                <h3 className="text-xl font-bold text-foreground">JohnGPT Creator Assistant</h3>
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-muted-foreground ml-2">(214 reviews)</span>
              </div>
              <div className="flex justify-between items-center">
                <div>
