    ...
    <section className="py-16 bg-gray-100 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Category 1 */}
          <Link href="#courses" className="block bg-white dark:bg-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Video Courses</h3>
          ...
          {/* Category 2 */}
          <Link href="#templates" className="block bg-white dark:bg-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Templates</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          {/* Category 3 */}
          <Link href="#tools" className="block bg-white dark:bg-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          {/* Category 4 */}
          <Link href="#free" className="block bg-white dark:bg-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Free Resources</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
