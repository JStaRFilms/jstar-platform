      ...
      if (!response.ok) {
        ...
        if (response.status === 400 && result.errors) {
          ...
          result.errors.forEach((error: string) => {
            ...
            else if (error.toLowerCase().includes('email')) serverErrors.email = error;
            else if (error.toLowerCase().includes('subject')) serverErrors.subject = error;
            else if (error.toLowerCase().includes('service')) serverErrors.service = error;
            else if (error.toLowerCase().includes('message')) serverErrors.message = error;
