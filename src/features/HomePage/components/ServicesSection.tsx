        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Cinematic wedding films, event coverage, and brand storytelling with drone footage and professional editing.
            </p>
            <Link href="/portfolio" className="text-jstar-blue font-semibold hover:text-faith-purple transition-colors">
              View Portfolio →
            </Link>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Custom web and mobile applications built with modern frameworks, optimized for performance and user experience.
            </p>
            <Link href="/portfolio" className="text-faith-purple font-semibold hover:text-growth-green transition-colors">
              See Projects →
            </Link>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              AI-powered tools for content creation, YouTube optimization, and audience growth. Including JohnGPT assistant.
            </p>
            <Link href="/store" className="text-growth-green font-semibold hover:text-jstar-blue transition-colors">
              Explore Tools →
            </Link>
          </div>
        </div>
