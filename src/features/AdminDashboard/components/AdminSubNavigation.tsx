  ...
  const getSubItems = (category: string) => {
    const subItemsMap: Record<string, Array<{ id: string; label: string; icon: string; route?: string }>> = {
      ...
      'notifications': [
        ...
        { id: 'communications-inbox', label: 'Communications Inbox', icon: 'M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207', route: '/admin/communications/inbox' },
