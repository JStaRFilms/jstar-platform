...
export const ModuleAccess: React.FC = () => {
  const modules = [
    ...
    },
    {
      ...
      description: 'Access all CGE tools',
      href: '/admin/cge',
      icon: (
        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Manage user accounts & tiers',
      href: '/admin/users',
      icon: (
        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="space-y-4">
        {modules.map((module, index) => (
          <Link
            key={index}
            href={module.href}
            className="module-card block p-4 border-l-2 border-transparent hover:border-admin-red rounded-r-lg"
          >
