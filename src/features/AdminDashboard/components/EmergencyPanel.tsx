 ...
 * Provides critical system recovery and emergency functions
 */
  ...
  return (
    <div className="bg-red-50 dark:bg-red-900/20 rounded-2xl p-6 shadow-lg border border-red-200 dark:border-red-800">
      ...
      <div className="space-y-3">
        ...
        <button className="w-full px-4 py-2 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-lg font-medium btn-enhanced">
