...
const MyPhilosophy = () => {
  return (
    <div id="philosophy" className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg mb-8">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">My Philosophy</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Faith-Driven Creation</h3>
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Innovation with Purpose</h3>
          <p className="text-gray-600 dark:text-gray-400">
