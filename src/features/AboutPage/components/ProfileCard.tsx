...
const ProfileCard = () => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg mb-8 sticky top-24">
      <div className="text-center mb-6">
        ...
        <h3 className="text-xl font-bold text-gray-900 dark:text-white">John Oluleke-Oke</h3>
