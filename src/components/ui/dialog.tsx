...
// Split positioning and default styles to allow custom positioning
...
>(({ className, children, hideDefaultClose = false, overlayClassName, hideOverlay = false, ...props }, ref) => {
  ...
  const defaultCenteredClasses = "fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]";
