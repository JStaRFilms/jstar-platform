...
export const V2Manifesto: React.FC = () => {
  return (
    <section id="manifesto" className="py-28 px-6 bg-ink-black relative border-b border-powder-blue/15">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-base sm:text-lg text-powder-blue/80 leading-relaxed font-light">
            {`When the filmmaker understands algorithmic optimization and the software engineer understands pacing, tension, and color grading, the work reaches a standard most agencies can't match.`}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-card border border-powder-blue/15 flex flex-col justify-between space-y-8 shadow-xl">
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-powder-blue/80 leading-relaxed font-light">
                  Story architecture, high-retention video editing, DaVinci Resolve color science grading, and dynamic multi-camera broadcasting that commands audience attention.
                </p>
              </div>

              <div className="space-y-2 pt-4 border-t border-powder-blue/10 text-xs font-mono text-powder-blue/70">
                <div className="flex justify-between py-1.5 border-b border-powder-blue/5">
            ...
            <div className="h-full flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-powder-blue/80 leading-relaxed font-light">
                    Full-stack TypeScript applications, local-first ONNX neural networks, and automated creator tooling engineered for zero latency and data privacy.
                  </p>
                </div>
