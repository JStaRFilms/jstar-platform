...
export const V2SelectedWork: React.FC = () => {
              ...
              >
                  ...
                  <div className="absolute top-4 left-4 z-10">
                    <span className={`px-3 py-1 rounded-md text-[10px] font-mono font-bold uppercase tracking-wider border ${
                      project.category === 'video'
                        ? 'bg-toffee-brown/90 text-ghost-white border-toffee-brown'
                        : 'bg-ink-black/90 text-chartreuse border-chartreuse/30'
                    }`}>
                      {project.category === 'video' ? 'FILM' : 'SOFTWARE / AI'}
                    </span>
                  </div>
                ...
                <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-6">
                  ...
                  <div className="pt-4 border-t border-powder-blue/10 flex items-center justify-between text-xs font-mono">
                    <span className="text-powder-blue/60">View Case Study</span>
